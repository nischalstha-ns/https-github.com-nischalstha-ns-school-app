...
export const RESULTS: Omit<Result, 'id'>[] = [
    {
        ...
        date: '2030-12-15',
        subjects: [
            { name: 'English', theoryMax: 80, practicalMax: 20, theoryObtained: 70, practicalObtained: 18 },
            { name: 'Mathematics', theoryMax: 100, practicalMax: 0, theoryObtained: 95, practicalObtained: 0 },
            { name: 'Science', theoryMax: 70, practicalMax: 30, theoryObtained: 65, practicalObtained: 28 },
            { name: 'Social Studies', theoryMax: 100, practicalMax: 0, theoryObtained: 88, practicalObtained: 0 },
            { name: 'Computer Science', theoryMax: 50, practicalMax: 50, theoryObtained: 45, practicalObtained: 48 },
        ],
        totalMarksObtained: 457,
    ...
    },
    {
        ...
        date: '2030-12-15',
        subjects: [
            { name: 'English', theoryMax: 80, practicalMax: 20, theoryObtained: 55, practicalObtained: 15 },
            { name: 'Mathematics', theoryMax: 100, practicalMax: 0, theoryObtained: 65, practicalObtained: 0 },
            { name: 'Science', theoryMax: 70, practicalMax: 30, theoryObtained: 40, practicalObtained: 22 },
            { name: 'Social Studies', theoryMax: 100, practicalMax: 0, theoryObtained: 72, practicalObtained: 0 },
            { name: 'Computer Science', theoryMax: 50, practicalMax: 50, theoryObtained: 35, practicalObtained: 40 },
        ],
        totalMarksObtained: 344,
        totalPossibleMarks: 500,
        percentage: 68.8,
        grade: 'C',
        status: 'Passed',
        remarks: 'Satisfactory performance. Can improve in Science and Mathematics.'
    },
    {
        studentId: 'S-003',
        ...
        date: '2030-09-15',
        subjects: [
            { name: 'English', theoryMax: 100, practicalMax: 0, theoryObtained: 82, practicalObtained: 0 },
            { name: 'Mathematics', theoryMax: 100, practicalMax: 0, theoryObtained: 91, practicalObtained: 0 },
            { name: 'Science', theoryMax: 70, practicalMax: 30, theoryObtained: 60, practicalObtained: 25 },
        ],
        totalMarksObtained: 258,
        totalPossibleMarks: 300,
        percentage: 86.0,
        grade: 'A',
        status: 'Passed',
        remarks: 'Very good progress this term.'
    },
];
